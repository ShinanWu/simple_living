...
export DEPLOY_EXTRA_RUN_ARGS="-e GATEWAY_USER_SERVER_ADDR=${GATEWAY_USER_SERVER_ADDR} -e GATEWAY_RECOMMENDATION_SERVER_ADDR=${GATEWAY_RECOMMENDATION_SERVER_ADDR} -e GATEWAY_TRACKING_SERVER_ADDR=${GATEWAY_TRACKING_SERVER_ADDR} -e GATEWAY_BACKOFFICE_BACKEND_ADDR=${GATEWAY_BACKOFFICE_BACKEND_ADDR} -e EXPORT_DIR=/var/lib/simple-living/exports"
