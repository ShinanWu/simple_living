...
EOF
  ...
  # When proxy runs FRP_EMBEDDED=1, docker publishes 10080 (TCP visitor) and 7000 (frps control).
  if [[ "${name}" == "nginx" ]]; then
    netdev_args="${netdev_args},hostfwd=tcp::11080-:10080,hostfwd=tcp::17000-:7000"
  fi
...
echo "Proxy-scoped lab nodes started."
